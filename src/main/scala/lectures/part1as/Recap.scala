...
object Recap extends App {
  ...
  val aConditionedVal = if (aCondition) 42 else 6
  ...
  val throwsException = throw new RuntimeException // the type of this expression is Nothing
